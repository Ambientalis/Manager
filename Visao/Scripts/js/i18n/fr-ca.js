// French-Canadian
plupload.addI18n({
    'Selecione os Arquivos' : 'Sélectionnez les fichiers',
    'Selecione arquivos no botão abaixo' : 'Ajoutez des fichiers à la file d\'attente et appuyez sur le bouton démarrer.',

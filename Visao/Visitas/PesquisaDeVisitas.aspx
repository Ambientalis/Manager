<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeFile="PesquisaDeVisitas.aspx.cs" Inherits="Visitas_PesquisaDeVisitas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="Server">
            ...
            <table align="center" width="100%">
                ...
                <tr>
                    ...
                    <td style="width: 15%; padding-right: 15px;">
                        ...
                        <div class="filtros_campo">
                            <asp:DropDownList ID="ddlTipoVisita" runat="server" CssClass="dropDownList100">
                            </asp:DropDownList>
                        </div>
                    </td>
                    <td style="width: 15%; padding-right: 15px;">
    ...
    <div style="position: relative; margin-top: 20px;">
        <asp:UpdatePanel ID="upVisitas" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:GridView ID="gdvVisitas" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="0px" CssClass="grid" DataKeyNames="Id" EnableModelValidation="True" OnPageIndexChanging="gdvVisitas_PageIndexChanging" OnPreRender="gdvVisitas_PreRender" PageSize="10">
                    <Columns>
                        ...
                        <asp:BoundField DataField="GetAceita" HeaderText="Aceita pelo cliente">
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="gdvVisitas" EventName="SelectedIndexChanging" />
            </Triggers>
        </asp:UpdatePanel>
    </div>
</asp:Content>
